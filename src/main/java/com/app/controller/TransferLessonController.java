...
public class TransferLessonController {
  ...
  @PostMapping
  @JsonView(View.TransferLesson.class)
  public ResponseEntity<TransferLessonResponse> createLesson(@RequestBody TransferLessonRequest request) {
    TransferLessonResponse response = transferLessonFacade.createLesson(request);
