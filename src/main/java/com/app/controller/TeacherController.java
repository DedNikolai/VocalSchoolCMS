...
public class TeacherController {
  ...
  @JsonView(View.Teacher.class)
  @PreAuthorize("hasAnyAuthority('SUPER_ADMIN, ADMIN')")
  public ResponseEntity<List<TeacherResponse>> fidAllTeachersByDiscipline(@RequestParam String param) {
    List<TeacherResponse> response = teacherFacade.teachersByDiscipline(param);
    return ResponseEntity.ok(response);
  }
